...
import (
    ...
    "{{.module_name}}/gen/rpc/base"
    "{{.module_name}}/gen/rpc/user"
    userSvc "{{.module_name}}/internal/app/user"
)
...
import (
    "{{.module_name}}/gen/rpc/user/userservice"
    "{{.module_name}}/internal/transport/rpc/handler"
)
